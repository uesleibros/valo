...
impl<'a> Lexer<'a> {
    ...
    fn identifier(&mut self) -> Token {
        ...
        let kind = match lower.as_str() {
            ...
            "imports" if hint.is_none() => TokenKind::Imports,
            ...
            "delegate" if hint.is_none() => TokenKind::Delegate,
            ...
            "isnot" if hint.is_none() => TokenKind::IsNot,
            ...
            "partial" if hint.is_none() => TokenKind::Partial,
            ...
            "from" if hint.is_none() => TokenKind::From,
            ...
            "andalso" if hint.is_none() => TokenKind::AndAlso,
            "or" if hint.is_none() => TokenKind::Or,
            "orelse" if hint.is_none() => TokenKind::OrElse,
            ...
            "operator" if hint.is_none() => TokenKind::Operator,
